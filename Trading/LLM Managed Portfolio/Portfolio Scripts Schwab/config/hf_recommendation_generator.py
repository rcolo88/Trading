...
class HFRecommendationGenerator:
    ...
    def __init__(self):
        ...
        self.news_agent = NewsAgent(HFConfig.MODELS["news"])
        self.market_agent = MarketAgent(HFConfig.MODELS["market"])
        self.risk_agent = RiskAgent(HFConfig.MODELS["risk"])
        self.tone_agent = ToneAgent(HFConfig.MODELS["tone"])
