...
from data.watchlist_config import (
    WatchlistIndex,
    WatchlistConfig,
...
class TestIndexFetchers(unittest.TestCase):
    ...
    def test_get_sp500_tickers_integration(self, mock_read_html):
        ...
        from data.financial_data_fetcher import get_sp500_tickers
    ...
    def test_get_sp400_tickers_integration(self, mock_read_html):
        ...
        from data.financial_data_fetcher import get_sp400_tickers
    ...
    def test_get_sp600_tickers_integration(self, mock_read_html):
        ...
        from data.financial_data_fetcher import get_sp600_tickers
    ...
    def test_get_nasdaq100_tickers_integration(self, mock_read_html):
        ...
        from data.financial_data_fetcher import get_nasdaq100_tickers
