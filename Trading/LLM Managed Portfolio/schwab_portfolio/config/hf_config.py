...
class HFConfig:
    ...
    # NOTE: router.huggingface.co has known 404 bugs as of Nov 2025
    # Using stable serverless inference API instead
    HF_API_URL = "https://api-inference.huggingface.co/models/"
    HF_TOKEN = os.getenv("HUGGINGFACE_TOKEN")  # Set via: export HUGGINGFACE_TOKEN='your_token_here'
