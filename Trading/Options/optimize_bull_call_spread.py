...
from src.strategies.vertical_spreads import BullCallSpread
...
def print_header() -> None:
    """Print script header."""
    print("\n" + "="*70)
    print("BULL CALL SPREAD OPTIMIZATION")
    print("="*70)
...
def main() -> int:
    ...
    try:
        ...
        if 'caffeinate' not in ' '.join(os.popen('ps aux | grep caffeinate').read().split()):
            ...
            print("   Recommended: caffeinate -i python optimize_bull_call_spread.py\n")
